...
string MaterialBASE::GetMaterial(string type, int i)
{
	...
	{
		return BASE[i].Material.GetBrand() + ", " + BASE[i].Material.GetDesignation() + ". Цена: " + to_string(BASE[i].cost) + " грн/" + BASE[i].Material.GetDimension();
	}
	return temp;
}

double MaterialBASE::GetCosting(int i)
{
	return BASE[i].cost;
}

double MaterialBASE::GetQTY(int i)
{
	return BASE[i].QTY;
}
...
bool MaterialBASE::isMDF(int i)
{
	size_t digits = BASE[i].Material.GetTypeOfMaterial().find("МДФ");
	if (digits <= BASE[i].Material.GetTypeOfMaterial().size())
	{
		return true;
	}
...
bool MaterialBASE::isHDF(int i)
{
	size_t digits = BASE[i].Material.GetTypeOfMaterial().find("ХДФ");
	if (digits <= BASE[i].Material.GetTypeOfMaterial().size())
	{
		return true;
	}
...
bool MaterialBASE::isFurniture(int i)
{
	size_t digits = BASE[i].Material.GetTypeOfMaterial().find("Петля");
	if (digits <= BASE[i].Material.GetTypeOfMaterial().size())
	{
		return true;
	}
...
bool MaterialBASE::isFix(int i)
{
	size_t digits = BASE[i].Material.GetTypeOfMaterial().find("Крепеж");
	if (digits <= BASE[i].Material.GetTypeOfMaterial().size())
	{
		return true;
	}
...
bool MaterialBASE::isTorts(int i)
{
	size_t digits = BASE[i].Material.GetTypeOfMaterial().find("Торцовка");
	if (digits <= BASE[i].Material.GetTypeOfMaterial().size())
	{
		return true;
	}
...
bool MaterialBASE::isFasadCover(int i)
{
	size_t digits = BASE[i].Material.GetTypeOfMaterial().find("Краска");
	if (digits <= BASE[i].Material.GetTypeOfMaterial().size())
	{
		return true;
	}
	size_t digits2 = BASE[i].Material.GetTypeOfMaterial().find("Пленка");
	if (digits2 <= BASE[i].Material.GetTypeOfMaterial().size())
	{
		return true;
	}
	return false;
...
bool MaterialBASE::isLeg(int i)
{
	size_t digits = BASE[i].Material.GetTypeOfMaterial().find("Ножка");
	if (digits <= BASE[i].Material.GetTypeOfMaterial().size())
	{
		return true;
	}
...
{
	return BASE[i].Material.GetTypeOfMaterial() + " " + BASE[i].Material.GetBrand() + ", " + BASE[i].Material.GetDesignation() + +". Цена: " + to_string(BASE[i].cost) + " грн/" + BASE[i].Material.GetDimension();
}
